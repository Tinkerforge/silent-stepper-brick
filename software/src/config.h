...
// LED
#define PIN_LED_STD_BLUE    {1 << 17, PIOA, ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
#define PIN_LED_STD_RED     {1 << 18, PIOA, ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
...
// *************** TMC2130 PINS ***************
#define PIN_ENABLE      {1 << 27, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
...
#define PIN_CLK         {1 << 7, PIOA, ID_PIOA, PIO_PERIPH_B, PIO_DEFAULT}
...
#define PIN_PWR_CS      {1 << 10,  PIOA, ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
